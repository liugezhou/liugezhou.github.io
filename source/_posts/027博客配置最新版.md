...
description:  这篇博客用来记录五一期间重新搭建博客的每一个小旅程，每一个小步骤，各种小细节记录与此，不让之前博客丢失的悲剧重现。
toc: true
category:
    博客搭建
tags:
...
> 之前还懵懂的产出三篇博客搭建的记录，万万没想到，写的真是有点糙。  
...
## 博文内容迁移和改造过程
> 主要是将语雀内容和之前博客内容迁移过来，初始博客内容为65篇。    
> 基于对过去博文的一个尊重，每篇文章再次阅读，加上description摘要和toc的显示目录功能
> 且早期的一些文章抄袭严重，或许有些过时，于是忍痛割爱，对所有抄袭内容过多的文章删去,一些质量不好的文章若全部出于原创就暂时保留。
